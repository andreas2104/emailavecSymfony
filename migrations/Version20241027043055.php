 ...
 */
final class Version20241027043055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE courrier ADD message TEXT NOT NULL');
        $this->addSql('ALTER TABLE courrier ADD supprime_expediteur BOOLEAN DEFAULT false NOT NULL');
        $this->addSql('ALTER TABLE courrier ADD supprime_destinataire BOOLEAN DEFAULT false NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE courrier DROP message');
        $this->addSql('ALTER TABLE courrier DROP supprime_expediteur');
        $this->addSql('ALTER TABLE courrier DROP supprime_destinataire');
